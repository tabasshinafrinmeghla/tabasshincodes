      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4  w-full mx-auto px-8">
        <Card title="Planning & Strateg"
          icon={<AceternityIcon order="Phase 1" />} 
           description="Before starting any project, I like to plan and strategize. This helps me understand the requirements and create a roadmap for the project.">
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        <h2 className="dark:text-white-100 text-sm opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200 text-center ">
          {description}
        </h2>
      </div>
    </div>
